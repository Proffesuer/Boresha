...
<div class="container">
<h3 style="background-color:#111827"><a href="../index.php"><b>Home</b></a></h3>
</div>
    <div class="container"style="background-color:black; opacity: 0.8;" ><br>
	<center>
	<img src="./images/Levis5405.png" width="100"height="100" style="border-radius: 80%"class="img response"> 
</center>
          <h1 class="text-center"style="color:white">User Login</h1><hr><br>
