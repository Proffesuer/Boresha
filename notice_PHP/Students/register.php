...
<html lang="en">
  ...
  <div class="container"style="background-color:black; opacity: 0.8;" >
   <br>
          <h1 class="text-center"style="color:white">Register Users!</h1><hr><br>
          ...
          <div class="row animate__animated animate__pulse">
            <div class="col-md-8 offset-md-2">
             	<form method="POST" enctype="multipart/form-data">
				  <div class="form-group row">
				    <div class="col-sm-6">
				      <input type="text" class="form-control" value="<?= isset($name)? $name:'' ?>" name="name" placeholder="Name" id="inputEmail3"><?= isset($input_error['name'])? '<label for="inputEmail3" class="error">'.$input_error['name'].'</label>':'';  ?><br>
				    </div>
				    <div class="col-sm-6">
				      <input type="email" class="form-control" value="<?= isset($email)? $email:'' ?>" name="email" placeholder="Email" id="inputEmail3"><?= isset($input_error['email'])? '<label class="error">'.$input_error['email'].'</label>':'';  ?><br>
			...
			<p>If you have account, you can <a href="login.php"style="color:white"><b>Login</b></a> your account!</p>
          </div>
