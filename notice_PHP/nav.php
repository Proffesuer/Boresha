...
<h1 class="mb-0 site-logo "><a href="./"><b>BORESHAn</b><span class="text-primary"></span> </a></h1>
</div>
...
<li><a href="#services-section" class="nav-link">Memos</a></li>
<li><a href="#faq-section" class="nav-link">Internships&Jobs</a></li>
<li class="has-children">
<a href="#">News</a>
<ul class="dropdown">
